...
class RegisterUserRequest extends Request
{
    ...
    |--------------------------------------------------------------------------
    |
    | Валидация параметров запроса, полученных при регистрации пользователя.
    |
    */
     ...
     *
     * Метод расширен - после успешной валидации создаются дополнительные параметры запроса - mobile и email. После
     * этого для одного из них устанавливается значение исходя из того, какое значение имеет параметр mobile_or_email.
     *
     * @return void
     */
