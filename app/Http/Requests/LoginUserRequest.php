...
class LoginUserRequest extends Request
{
    ...
    |--------------------------------------------------------------------------
    |
    | Валидация параметров запроса, полученных при аутентификации пользователя.
    |
    */
     ...
     *
     * Метод расширен - после успешной валидации на основе параметра login создаётся дополнительный параметр запроса -
     * username, mobile или email.
     *
     * @return void
     */
