...
class FileController extends Controller
{
    ...
    */
    ...
    /**
     * Формирует уникальное имя для заданного файла на указанном диске.
     * Возвращает массив, первый элемент которого - папка, в которой будет храниться файл, второй элемент массива -
    ...
    /**
     * Формирует путь к файлу с указанным именем. Путь должен состоять из папок двойной вложенности.
