...
class LoginController extends Controller
{
    ...
    */
     ...
     * Метод переопределён.
     * Для валидации запроса используется LoginUserRequest.
     *
     ...
     * Метод переопределён.
     * В сессии сохраняется имя поля формы аутентификации, содержащее логин, а не название параметра запроса,
     ...
     * Метод переопределён.
     * Возвращается название дополнительного параметра запроса - username, mobile или email, который был добавлен
     * валидатором.
     *
     * @return string
     */
